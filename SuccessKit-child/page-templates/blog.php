...
<section class="cat-area container mt-4 mb-1 pt-3">
	<nav class="cat-nav d-flex justify-content-center">
		...
		<ul class="nav sans-serif d-flex justify-content-around">
			<li
				class="nav-item				               			                    <?php echo get_the_title() == 'Blog Resources' ? 'active' : ''; ?>">
...
<section class="container sans-serif my-5">
	<h2 class="sans-serif mb-4 pb-2" style="font-weight: 500; text-transform: initial;"><?php echo $category->name; ?>
	</h2>
	<div class="post-feed">
		<?php
            $args = array(
